...
class PluginsSnippet {
    ...
    SimplePlugin activityPlugin = SimplePlugin.newBuilder("PluginName")
    ...
    SimplePlugin workflowPlugin = SimplePlugin.newBuilder("PluginName")
    ...
    SimplePlugin nexusPlugin = SimplePlugin.newBuilder("PluginName")
            .registerNexusServiceImplementation(new WeatherService())
            .build();
    // @@@SNIPEND

    // @@@SNIPSTART java-plugin-converter
    SimplePlugin converterPlugin = SimplePlugin.newBuilder("PluginName")
            .customizeDataConverter(existingConverter -> {
    ...
    SimplePlugin interceptorPlugin = SimplePlugin.newBuilder("PluginName")
