...
RUN CGO_ENABLED=0 ./temporal-features prepare --lang java --dir prepared --version "$SDK_VERSION"
...
ENTRYPOINT ["/app/temporal-features", "run", "--lang", "java", "--prepared-dir", "prepared"]
